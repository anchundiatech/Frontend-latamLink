...
export default function HeroSection() {
  ...
  const [posState, setPosState] = useState<"idle" | "generating" | "success">("idle")
          ...
          <div className="bg-obsidian rounded-3xl p-8 w-[320px] shadow-2xl border border-white/10 relative overflow-hidden">
            ...
            {posState === "generating" ? (
              <div className="relative w-35 h-35 mx-auto mb-6 bg-white p-2 rounded-xl border border-white/10 flex items-center justify-center">
                ...
                <div className="absolute left-0 right-0 h-0.5 bg-primary shadow-md shadow-primary/80 animate-bounce" style={{ animationDuration: "2s" }} />
                ...
                <svg width="120" height="120" viewBox="0 0 100 100">
                  ...
                  <path d="M 35 5 h 5 v 5 h -5 z M 45 5 h 5 v 5 h -5 z M 55 5 h 5 v 5 h -5 z M 65 5 h 5 v 5 h -5 z M 35 15 h 5 v 5 h -5 z M 50 15 h 5 v 5 h -5 z M 60 15 h 5 v 5 h -5 z M 35 25 h 5 v 5 h -5 z M 45 25 h 5 v 5 h -5 z M 55 25 h 5 v 5 h -5 z M 5 35 h 5 v 5 h -5 z M 15 35 h 5 v 5 h -5 z M 25 35 h 5 v 5 h -5 z M 35 35 h 5 v 5 h -5 z M 45 35 h 5 v 5 h -5 z M 65 35 h 5 v 5 h -5 z M 75 35 h 5 v 5 h -5 z M 85 35 h 5 v 5 h -5 z M 10 45 h 5 v 5 h -5 z M 30 45 h 5 v 5 h -5 z M 50 45 h 5 v 5 h -5 z M 60 45 h 5 v 5 h -5 z M 80 45 h 5 v 5 h -5 z M 20 55 h 5 v 5 h -5 z M 40 55 h 5 v 5 h -5 z M 70 55 h 5 v 5 h -5 z M 90 55 h 5 v 5 h -5 z M 5 65 h 5 v 5 h -5 z M 35 65 h 5 v 5 h -5 z M 45 65 h 5 v 5 h -5 z M 55 65 h 5 v 5 h -5 z M 65 65 h 5 v 5 h -5 z M 85 65 h 5 v 5 h -5 z M 35 75 h 5 v 5 h -5 z M 45 75 h 5 v 5 h -5 z M 55 75 h 5 v 5 h -5 z M 65 75 h 5 v 5 h -5 z M 35 85 h 5 v 5 h -5 z M 45 85 h 5 v 5 h -5 z M 55 85 h 5 v 5 h -5 z M 65 85 h 5 v 5 h -5 z M 85 85 h 5 v 5 h -5 z" fill="black" />
                </svg>
              </div>
            ) : posState === "success" ? (
              <div className="flex flex-col items-center justify-center my-6 py-4 animate-scale-in">
                ...
                <div className="mt-4 text-success font-semibold text-base tracking-wide">
                  {locale === "es" ? "¡Transacción exitosa!" : "Transaction Successful!"}
                </div>
              </div>
            ) : (
            ...
            {posState === "generating" && (
              ...
              >
                ...
                {locale === "es" ? "Esperando confirmación..." : "Awaiting confirmation..."}
              </button>
            )}
